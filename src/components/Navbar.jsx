...
//           <Link
//             to="/loginRegister"
//             className="btn border border-white text-red-600 hover:bg-white hover:text-black transition duration-300"
//           >
//             Login
//           </Link>
//         )}
...
const Navbar = () => {
  ...
  return (
    <nav className="bg-base-100 dark:bg-gray-900 shadow-md sticky top-0 z-50 text-base-content dark:text-white transition duration-300">
      <div className="navbar max-w-7xl mx-auto px-4 lg:px-6">
        ...
        <div className="navbar-start">
          ...
          <div className="dropdown lg:hidden">
            ...
            <ul
              tabIndex={0}
              className="menu menu-sm dropdown-content mt-3 z-[99] p-3 shadow bg-base-100 rounded-box w-56 text-base-content dark:bg-gray-800 dark:text-white"
            >
              {navItems}
            </ul>
          </div>
        ...
        {/* Navbar End: ThemeToggle + User/Profile/Login */}
        <div className="navbar-end flex items-center gap-3">
          ...
          {user ? (
            <div className="dropdown dropdown-end">
              ...
              <ul
                tabIndex={0}
                className="mt-3 z-[99] p-3 shadow menu menu-sm dropdown-content bg-base-100 dark:bg-gray-800 rounded-box w-56 text-base-content dark:text-white"
              >
                <li>
            ...
            <Link
              to="/loginRegister"
              className="btn btn-sm md:btn-md border border-primary text-primary hover:bg-primary hover:text-white transition duration-300"
            >
              Login
            </Link>
          )}
